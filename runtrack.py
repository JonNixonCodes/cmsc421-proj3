"""
File: runtrack.py -- Dana Nau, Nov. 15, 2017
A simple program for running Project 3.
"""

import math, sys
import tdraw, turtle			# Code to use Python's "turtle drawing" package
import proj3					# File containing your program for Project 3
import maketrack
...
def main(problem=None, draw=1, single_step=0):
	...
	while True:
		...
		(xnew,ynew) = (x+u, y+v)
		print('Move {}: proj3.main chose velocity {}'.format(i,(u,v)), end='')
