"""
File: h3.py -- Dana, Sept. 3, 2017
The function h3 in this file is my best heuristic function for Project 3.
"""
...
def h_grid(state, fline, walls):
	"""calculate and return grid with heuristic values"""
	edist_grid(fline, walls)
	h_grid = grid.copy()
	return h_grid
